...
ENGINE_SRCS = \
	...
	src/engine/event/event_queue.c \
...
game: $(ENGINE_SRCS) $(GAME_SRCS) $(PLATFORM_SRCS) src/main.c
	$(CC) $(CFLAGS) $^ -o $@

test: architecture-check entity-test world-test command-test movement-test turn-test ai-test render-test event-test
...
movement-test: tests/movement_test.c src/engine/system/movement/movement.c src/engine/entity/entity_store.c src/engine/world/world.c src/engine/event/event_queue.c
	$(CC) $(CFLAGS) $^ -o movement_test
	./movement_test

turn-test: tests/turn_test.c src/engine/turn/turn.c src/engine/system/movement/movement.c src/engine/entity/entity_store.c src/engine/world/world.c src/engine/event/event_queue.c
	$(CC) $(CFLAGS) $^ -o turn_test
	./turn_test

ai-test: tests/ai_test.c src/engine/system/ai/ai.c src/engine/system/movement/movement.c src/engine/entity/entity_store.c src/engine/world/world.c src/engine/event/event_queue.c
	$(CC) $(CFLAGS) $^ -o ai_test
	./ai_test
...
event-test: tests/event_queue_test.c src/engine/event/event_queue.c
	$(CC) $(CFLAGS) $^ -o event_queue_test
	./event_queue_test

clean:
	rm -f game entity_store_test world_test command_test movement_test turn_test ai_test render_test event_queue_test
